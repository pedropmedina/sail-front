...
export const SelectResults = styled.div`
  display: none;
  padding: 2rem 0;
  background-color: #fff;
...
export const SelectResultsList = styled.ul`
  list-style: none;
`;

export const SelectResultsItem = styled.li`
...
export const SelectPicksList = styled(SelectResultsList)`
  display: flex;
  flex-wrap: wrap;
`;
